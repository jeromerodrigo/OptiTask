...
public class AppController implements ActionListener {
	...
	public AppController(optitask.store.AppPersistence model, optitask.ui.AppFrame view) {
		this.model = model;
		this.view = view;
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(actionCommand.equalsIgnoreCase("Start")) {
			...
			JOptionPane.showMessageDialog(settingsDialog, "Settings saved!", "Notification",
			...
			settingsDialog.setEnabledIncrementSettings(!settingsDialog.isEnabledIncrementSettings());
			...
			JOptionPane.showMessageDialog(tasksDialog, "Tasks saved!", "Notification",
					JOptionPane.INFORMATION_MESSAGE);
