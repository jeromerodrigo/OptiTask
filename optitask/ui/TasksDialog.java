...
public class TasksDialog extends JDialog {
	...
	private void initialize() {
		...
		setModal(true);
		setResizable(false);
		setIconImage(Toolkit.getDefaultToolkit().getImage(TasksDialog.class.getResource("/optitask/assests/pencil.gif")));
		...
		btnMoveUp.setIcon(new ImageIcon(TasksDialog.class.getResource("/optitask/assests/upArrow.gif")));
		...
		btnMoveDown.setIcon(new ImageIcon(TasksDialog.class.getResource("/optitask/assests/downArrow.gif")));
	...
	public void moveUp() {
		swapItems(tasksTable.getSelectedRow(), 
	...
	private void swapItems(int selectedIdx, int nextIdx) {
		...
		try {
			...
			JOptionPane.showMessageDialog(getParent(), 
					"No row to move to!", "Error", JOptionPane.WARNING_MESSAGE);
			return;
		}		
